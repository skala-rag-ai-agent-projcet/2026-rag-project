...
### 왜 SK 시너지를 추가했는가 — VC를 넘어 CVC 관점으로

과제 주제는 **"AI 스타트업 투자 평가 에이전트 개발"**이고, 도메인으로 에너지를 선택했습니다. 일반 VC의 투자 판단 기준(Bessemer's Checklist, Scorecard Method)은 이미 잘 정립되어 있어서, 이 기준만으로 시스템을 만들면 누구나 만들 수 있는 범용 평가기가 됩니다.

여기에 차별점을 두기 위해 **SK 사업 시너지(15%)**를 커스텀 항목으로 추가했습니다. 이를 통해 일반 VC가 보는 "이 스타트업이 돈이 되는가?"를 넘어, CVC(Corporate Venture Capital)가 보는 **"우리 모기업 밸류체인과 시너지가 있는가?"**까지 평가할 수 있게 됩니다.

이 CVC 관점은 싱글/배치 두 모드에서도 일관되게 적용됩니다. 싱글 모드에서는 "이 기업이 SK와 구체적으로 어떤 시너지가 있는지" 심층 분석하고, 배치 모드에서는 "SK 시너지 기준까지 포함해서 여러 기업을 스크리닝"합니다. 실제 배치 결과에서 기각된 11개 기업의 공통 약점이 SK 시너지(평균 5.1/15)였다는 점이 이 설계의 유효성을 보여줍니다.
...
<img width="1403" height="784" alt="스크린샷 2026-03-13 오전 11 20 15" src="https://github.com/user-attachments/assets/e67fe470-cd88-4c82-8706-734c8253b91e" />

<img width="1403" height="782" alt="스크린샷 2026-03-13 오전 11 20 57" src="https://github.com/user-attachments/assets/bcc6c1cb-38ec-4a07-9dcb-5258fc9e3d64" />
...
<img width="502" height="898" alt="스크린샷 2026-03-13 오전 11 22 31" src="https://github.com/user-attachments/assets/0d58e8fa-7f10-4ec7-b399-cb1620d5d332" />
...
<img width="957" height="929" alt="스크린샷 2026-03-13 오전 11 24 46" src="https://github.com/user-attachments/assets/be5c4d87-9f55-40e7-9213-cf31ca076983" />
...
<img width="948" height="426" alt="스크린샷 2026-03-13 오전 11 25 41" src="https://github.com/user-attachments/assets/d5bee501-767f-436e-85a6-5adc122f02de" />

<img width="906" height="273" alt="스크린샷 2026-03-13 오전 11 25 53" src="https://github.com/user-attachments/assets/07b74b01-7275-43aa-9bf4-606ade48aeec" />
...
<img width="2798" height="2337" alt="ablation_comparison_detailed" src="https://github.com/user-attachments/assets/7e2c09c6-28bd-4030-aded-b53f83e3f796" />
